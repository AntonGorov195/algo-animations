...
files="$OUT_DIR/game.wasm.o ${ODIN_PATH}/vendor/raylib/wasm/libraylib.a ${ODIN_PATH}/vendor/raylib/wasm/libraygui.a ${ODIN_PATH}/vendor/clay/wasm/clay.o"

# index_template.html contains the javascript code that calls the procedures in
# source/main_web/main_web.odin
flags="-sUSE_GLFW=3 -sWASM_BIGINT -sWARN_ON_UNDEFINED_SYMBOLS=0 -sASSERTIONS -s EXPORTED_RUNTIME_METHODS=HEAPF32 --shell-file source/main_web/index_template.html --preload-file assets"
