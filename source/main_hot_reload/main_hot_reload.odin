...
_ :: mem
USE_BACKTRACE_ALLOCATOR :: #config(USE_BACKTRACE_ALLOCATOR, false)
...
Game_API :: struct {
	...
	post_hot_reloaded: proc(mem: rawptr),
...
when USE_BACKTRACE_ALLOCATOR {
	Tracking_Allocator :: back.Tracking_Allocator

	tracking_allocator_print_results :: back.tracking_allocator_print_results
	tracking_allocator_init :: back.tracking_allocator_init
	tracking_allocator_get :: back.tracking_allocator
	tracking_allocator_clear :: back.tracking_allocator_clear
	tracking_allocator_destroy :: back.tracking_allocator_destroy

	reset_tracking_allocator :: proc(a: ^Tracking_Allocator) -> bool {
		err := false

		tracking_allocator_print_results(a)
	...
	tracking_allocator_get :: mem.tracking_allocator
	tracking_allocator_clear :: mem.tracking_allocator_clear
...
main :: proc() {
	...
	context.allocator = tracking_allocator_get(&tracking_allocator)
